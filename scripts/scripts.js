function carregarNoticiasPrincipal(){
    ...
    document.getElementById("titulodaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[0].TITULO;
    document.getElementById("autordaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[0].AUTOR;
    document.getElementById("textodaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[0].TEXTO;
...
function carregarNoticiasAleatorias(){
	...
	if(sort==1){
        ...
        document.getElementById("categoriadaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[1].CATEGORIA;
        document.getElementById("titulodaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[1].TITULO;
        document.getElementById("autordaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[1].AUTOR;
        document.getElementById("textodaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[1].TEXTO;
	}else if(sort==3){
        document.getElementById("categoriadaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[2].CATEGORIA;
        document.getElementById("titulodaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[2].TITULO;
        document.getElementById("autordaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[2].AUTOR;
        document.getElementById("textodaNoticiaPrincipal").innerText = PortalDeNoticias.Principais[2].TEXTO;
    }
}
}
function carregarNoticiasAleatorias1(){
	...
	if(sort==1){
        ...
        document.getElementById("categoriadaNoticiaPolitica01").innerText = PortalDeNoticias.Politica[2].CATEGORIA;
        document.getElementById("titulodaNoticiaPolitica01").innerText = PortalDeNoticias.Politica[2].TITULO;
        document.getElementById("autordaNoticiaPolitica01").innerText = PortalDeNoticias.Politica[2].AUTOR;
        document.getElementById("textodaNoticiaPolitica01").innerText = PortalDeNoticias.Politica[2].TEXTO;
    }
}
}
function carregarNoticiasAleatorias2(){
	...
	if(sort==1){
        ...
        document.getElementById("categoriadaNoticiaSaude02").innerText = PortalDeNoticias.Saude[1].CATEGORIA;
        document.getElementById("titulodaNoticiaSaude02").innerText = PortalDeNoticias.Saude[1].TITULO;
        document.getElementById("autordaNoticiaSaude02").innerText = PortalDeNoticias.Saude[1].AUTOR;
        document.getElementById("textodaNoticiaSaude02").innerText = PortalDeNoticias.Saude[1].TEXTO;
	}else if(sort==3){
        document.getElementById("categoriadaNoticiaSaude02").innerText = PortalDeNoticias.Saude[2].CATEGORIA;
        document.getElementById("titulodaNoticiaSaude02").innerText = PortalDeNoticias.Saude[2].TITULO;
        document.getElementById("autordaNoticiaSaude02").innerText = PortalDeNoticias.Saude[2].AUTOR;
